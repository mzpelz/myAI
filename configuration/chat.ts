...
export const INITIAL_MESSAGE: string = `Hello, I'm ${AI_NAME}, your guide to navigating life at Kenan-Flagler Business School (KFBS). I was created by ${OWNER_NAME} to help international students like you feel at home! What’s on your mind today?.`;
